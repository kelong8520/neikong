  ...
  <div>
    ...
    >
      ...
      <el-table-column label="本期验布" align="center">
        <el-table-column prop="jianShuYB" label="件数" align="center"></el-table-column>
        <el-table-column prop="lengthYB" label="长度(m)" align="center"></el-table-column>
      </el-table-column>
      <el-table-column label="本期发坯" align="center">
        <el-table-column prop="jianShuFP" label="件数" align="center"></el-table-column>
        <el-table-column prop="lengthFP" label="长度(m)" align="center"></el-table-column>
      </el-table-column>
