<template>
  <div>
    ...
    >
      ...
      <el-table-column label="织造原料投入" align="center">
        <el-table-column label="纬纱" align="center">
          <el-table-column prop="weftName" label="纬纱名" align="center" width="120"></el-table-column>
          ...
          <el-table-column prop="weftUseTotal" label="总额" align="center" width="120"></el-table-column>
          ...
          <el-table-column prop="weftBiaoZhunPianCha" label="标准偏差" align="center" width="120"></el-table-column>
        </el-table-column>
      </el-table-column>
    </el-table>
  </div>
